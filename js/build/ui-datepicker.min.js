...
var d=c.parent(".input-group.date").datepicker(a);d.datepicker().on("changeDate",function(){var a=d.datepicker("getDate");a!=b.model&&b.$apply(function(){b.model=a})}),d.datepicker("update",b.model)})}}}])}();